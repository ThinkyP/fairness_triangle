...
def plot_reg(Y_pred_p,Y_pred_f, Y_pred_all, xx, yy, X_s_0, y_s_0, X_s_1, y_s_1, disc_factor, a):
    ...
    plt.scatter(X_s_0[y_s_0==-1.0][:, 0], X_s_0[y_s_0==-1.0][:, 1], color='red', marker='x', s=32, linewidth=1.4, label = "Prot. -ve")
    plt.scatter(X_s_1[y_s_1==1.0][:, 0], X_s_1[y_s_1==1.0][:, 1], color='lightgreen', marker='o', facecolors='none', s=30, label = "Non-prot. +ve")
    plt.scatter(X_s_1[y_s_1==-1.0][:, 0], X_s_1[y_s_1==-1.0][:, 1], color='orange', marker='o', facecolors='none', s=30, label = "Non-prot. -ve")
    ...
    new_labels = [f'disc_fact: {disc_factor:.2f}'] + [f'a: {a}'] + labels +   ['perf. reg'] + ['fair. reg'] + ['fair_aware reg']
    ...
    plt.legend(new_handles, new_labels, loc=2, fontsize=10)
    plt.title(f"Synthetic Data - disc_factor{disc_factor:.2f}")
    ...
    plt.xlim((-15,10))
    plt.ylim((-10,15))
    plt.savefig(f"img/data_df_{disc_factor:.2f}_a_{a}.png")
    plt.show()
...
def subplot_reg(ax, Y_pred_p, Y_pred_f, Y_pred_all, xx, yy, X_s_0, y_s_0, X_s_1, y_s_1, disc_factor, a, legend_flag=True):
    ...
    ax.scatter(X_s_0[y_s_0==-1.0][:, 0], X_s_0[y_s_0==-1.0][:, 1], color='red', marker='x', s=32, linewidth=1.4, label="Prot. -ve")
    ax.scatter(X_s_1[y_s_1==1.0][:, 0], X_s_1[y_s_1==1.0][:, 1], color='lightgreen', marker='o', facecolors='none', s=30, label="Non-prot. +ve")
    ax.scatter(X_s_1[y_s_1==-1.0][:, 0], X_s_1[y_s_1==-1.0][:, 1], color='orange', marker='o', facecolors='none', s=30, label="Non-prot. -ve")
